...
public:
    MinMaxCpuPlayer(char p, float(*aval)(Game& game, const MinMaxCpuPlayer *const self), int max_depth);
    ~MinMaxCpuPlayer() override = default;
    float(*aval)(Game& game, const MinMaxCpuPlayer *const self); // custom heuristic
    int max_depth;
